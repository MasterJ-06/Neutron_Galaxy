...
public class ModToolTiers {
    ...
    static {
        ...
        BRASS = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "brass"), List.of(Tiers.NETHERITE), List.of());
        ...
        BRONZE = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "bronze"), List.of(Tiers.NETHERITE), List.of());
        ...
        COBALT = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "cobalt"), List.of(Tiers.NETHERITE), List.of());
        ...
        COPPER = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "copper"), List.of(Tiers.NETHERITE), List.of());
        ...
        NICKEL = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "nickel"), List.of(Tiers.NETHERITE), List.of());
        ...
        PLATINUM = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "platinum"), List.of(Tiers.NETHERITE), List.of());
        ...
        RUBY = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "ruby"), List.of(Tiers.NETHERITE), List.of());
        ...
        SILVER = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "silver"), List.of(Tiers.NETHERITE), List.of());
        ...
        STEEL = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "steel"), List.of(Tiers.NETHERITE), List.of());
        ...
        TIN = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(NeutronGalaxy.MODID, "tin"), List.of(Tiers.NETHERITE), List.of());
    }
}
